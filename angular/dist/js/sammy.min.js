...
function ApprovalsCtrl(e,a,t,n,r,o){e.username=t.username,e.maintenance,e.features,a.get(r.url+"/maintenance/notapproved").success(function(a,t,n,r){e.maintenance=a}).error(function(e,a,t,n){o.addAlert("danger","fa-exclamation-triangle","Can't fetch car data")}),a.get(r.url+"/maintenance/notapprovedfeatures").success(function(a,t,n,r){e.features=a}).error(function(e,a,t,n){o.addAlert("danger","fa-exclamation-triangle","Can't fetch car features")}),e.approve=function(t){a({url:r.url+"/maintenance/approve",method:"POST",data:{id:t}}).then(function(a){for(o.addAlert("success","fa-check","Maintenance with id: "+t+" approved!"),i=0;i<e.maintenance.length;i++)e.maintenance[i].id==t&&e.maintenance.shift()},function(e){o.addAlert("danger","fa-exclamation-triangle","Failed to approve")})},e.approveFeature=function(t){a({url:r.url+"/maintenance/approveFeature",method:"POST",data:{id:t}}).then(function(a){for(o.addAlert("success","fa-check","Feature with id: "+t+" approved!"),i=0;i<e.features.length;i++)e.features[i].id==t&&e.features.shift()},function(e){o.addAlert("danger","fa-exclamation-triangle","Failed to approve")})}}app.controller("ApprovalsCtrl",["$scope","$http","$rootScope","$stateParams","Config","Alert",ApprovalsCtrl]);
function CarsCtrl(r,a,e,t,c){r.searchText={search:""},r.username=e.username,a.get(t.url+"/cars").success(function(a,e,t,c){r.cars=a}).error(function(r,a,e,t){c.addAlert("danger","fa-exclamation-triangle","Can't fetch car data")})}app.controller("CarsCtrl",["$scope","$http","$rootScope","Config","Alert",CarsCtrl]);
function CarDetailsCtlr(a,r,t,e,n,c,s){a.username=e.username,a.car,a.carParts,a.carMaintenance,t.get(c.url+"/cars/"+r.id).success(function(r,t,e,n){a.car=r}).error(function(a,r,t,e){s.addAlert("danger","fa-exclamation-triangle","Can't fetch car data")}),t.get(c.url+"/cars/parts/"+r.id).success(function(r,t,e,n){a.carParts=r}).error(function(a,r,t,e){s.addAlert("danger","fa-exclamation-triangle","Can't fetch car parts")}),t.get(c.url+"/cars/maintenance/"+r.id).success(function(r,t,e,n){a.carMaintenance=r}).error(function(a,r,t,e){s.addAlert("danger","fa-exclamation-triangle","Can't fetch car parts")})}app.controller("CarDetailsCtlr",["$scope","$stateParams","$http","$rootScope","$interval","Config","Alert",CarDetailsCtlr]);
function CarEditCtrl(a,t,e,n,r,d,i){console.log(t.id),e.get(r.url+"/cars/"+t.id).success(function(t,e,n,r){a.car=t}).error(function(a,t,e,n){d.addAlert("danger","fa-exclamation-triangle","Can't fetch car data")}),a.addData=function(a){e({url:r.url+"/maintenance/add",method:"POST",data:{description:a,Car_id:t.id}}).then(function(a){i.location.href="#/cars/",d.addAlert("success","fa-check","Maintenance added for review")},function(a){d.addAlert("danger","fa-exclamation-triangle","Failed to delete")})}}app.controller("CarEditCtrl",["$scope","$stateParams","$http","$interval","Config","Alert","$window",CarEditCtrl]);
function CarEditFeature(e,a,t,r,d,n,i){e.addData=function(e){a({url:d.url+"/maintenance/addFeature",method:"POST",data:{description:e,Car_id:t.id}}).then(function(e){i.location.href="#/cars/",n.addAlert("success","fa-check","Feature added for review")},function(e){n.addAlert("danger","fa-exclamation-triangle","Failed to delete")})}}app.controller("CarEditFeature",["$scope","$http","$stateParams","$interval","Config","Alert","$window",CarEditFeature]);
function ChartsCtrl(i,s,e,a,r){i.labels=["January","February","March","April","May","June","July"],i.series=["Series A","Series B"],i.data=[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]],i.onClick=function(i,s){console.log(i,s)},i.datasetOverride=[{yAxisID:"y-axis-1"},{yAxisID:"y-axis-2"}],i.options={scales:{yAxes:[{id:"y-axis-1",type:"linear",display:!0,position:"left"},{id:"y-axis-2",type:"linear",display:!0,position:"right"}]}}}app.controller("ChartsCtrl",["$scope","$http","$rootScope","Config","Alert",ChartsCtrl]);
