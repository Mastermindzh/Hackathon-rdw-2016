...
function HeaderCtrl(e,a,r,t,n){e.update=function(){var a=r.url();switch(a){case"/cars":e.currentPage="Mijn voertuigen";break;case"/cars/1":e.currentPage="Mijn voertuig details";break;case"/cars/2":e.currentPage="Mijn voertuig details";break;case"/cars/3":e.currentPage="Mijn voertuig details";break;case"/cars/details/edit/1":e.currentPage="Mijn voertuig aanpassen";break;case"/cars/details/edit/2":e.currentPage="Mijn voertuig aanpassen";break;case"/cars/details/edit/3":e.currentPage="Mijn voertuig aanpassen";break;case"/approval":e.currentPage="Aanpassingen goedkeuren";break;case"/addfeature":e.currentPage="Auto kenmerk toevoegen";break;default:e.currentPage="Inloggen"}e.crumbs=[],e.crumbs=a.split("/")},e.update(),a.$on("$stateChangeStart",function(a,r,t,n,c){e.update()})}app.controller("HeaderCtrl",["$scope","$rootScope","$location","Config","$http",HeaderCtrl]);
